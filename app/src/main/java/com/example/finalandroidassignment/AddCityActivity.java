...
public class AddCityActivity extends AppCompatActivity {
    ...
    public void add(View view){
        ...
        firebaseFirestore.collection("CITY").document(name.getText().toString().toUpperCase()).set(cityData).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(AddCityActivity.this, "Successfully added", Toast.LENGTH_SHORT).show();
                }
                else{
                ...
                public void onSuccess(
                    ...
                    downloadUrl.addOnCompleteListener(new OnCompleteListener<Uri>() {
                        ...
                        public void onComplete(@NonNull Task<Uri> task) {
                            ...
                            Toast.makeText(AddCityActivity.this, "Image Uploaded!!", Toast.LENGTH_SHORT).show();
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(AddCityActivity.this, "Failed " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
